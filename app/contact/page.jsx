    ...
    <div className="px-6 py-24 sm:py-32 lg:px-8 ">
      ...
      <form action="" className="mx-auto mt-16 max-w-xl sm:mt-20 ">
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          <div>
            <Button type="submit" className="flex w-full items-center px-8 py-3 text-white rounded-full shadow-lg hover:bg-gray-800 hover:ring-2 hover:ring-gray-950 ring-offset-2 ">Let's talk <TbArrowUpRight className="w-5 h-5 ml-2"/>
